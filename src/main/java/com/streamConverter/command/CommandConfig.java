 ...
 * コマンド設定クラス
 * 
 * <p>CommandFactoryで使用するコマンドの設定情報を保持します。
 * コマンドクラスとコンストラクタ引数を含みます。
 */
public class CommandConfig {
     ...
     * @param args コンストラクタ引数
     */
    public CommandConfig(Class<? extends IStreamCommand> commandClass, String description, Object... args) {
        this.commandClass = commandClass;
        this.args = args;
    ...
    public String toString() {
        return String.format("CommandConfig{class=%s, description='%s', args=%d}", 
