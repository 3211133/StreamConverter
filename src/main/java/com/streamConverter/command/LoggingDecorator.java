 ...
 * 
 * <p>このクラスは既存のIStreamCommandをラップして、詳細なログ出力機能を追加します。
 * デコレーターパターンを使用することで、既存のコマンドを変更せずに
 * 追加のログ機能を提供できます。
 * 
 * <p>使用例:
 * <pre>
...
public class LoggingDecorator implements IStreamCommand {
    ...
    public void execute(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        log.debug("Memory before execution: used={}MB, free={}MB, total={}MB",
        ...
        try {
            ...
            log.debug("Memory after execution: used={}MB (diff: {}MB)", 
                     usedMemoryAfter / 1024 / 1024, memoryDiff / 1024 / 1024);
    ...
    private void analyzePerformance(long duration, long memoryDiff) {
        ...
        if (duration > 1000 && memoryDiffMB > 10) {
            log.info("EFFICIENCY: {} may benefit from optimization (time: {}ms, memory: {}MB)", 
                    commandName, duration, memoryDiffMB);
        }
    }
