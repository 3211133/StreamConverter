 ...
 * output streams. MDC (Mapped Diagnostic Context) logging is supported through MDCContext for
 * enhanced traceability in multi-threaded environments.
 *
...
public interface IStreamCommand {
   ...
   *
   * <p>MDC context can be set using MDCContext before calling this method for enhanced logging
   * traceability in the StreamConverter pipeline.
   *
