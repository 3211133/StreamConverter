...
class TransformationRuleIntegrationTest {
  ...
  void testSnakeToCamelCaseWithJsonNavigate() throws Exception {
    ...
    IStreamCommand command =
        JsonNavigateCommand.createExtractValue("$.user_name", SnakeToCamelCaseRule.create());
  ...
  void testPascalCaseConversion() throws Exception {
    ...
    IStreamCommand command =
        JsonNavigateCommand.createExtractValue(
            "$.user_name", SnakeToCamelCaseRule.createPascalCase());
  ...
  void testChainRuleWithJsonNavigate() throws Exception {
    ...
    IStreamCommand command = JsonNavigateCommand.createExtractValue("$.fieldName", chainRule);
  ...
  void testComplexChainTransformation() throws Exception {
    ...
    IStreamCommand command = JsonNavigateCommand.createExtractValue("$.userAccountID", chainRule);
  ...
  void testRoundTripConversion() throws Exception {
    ...
    IStreamCommand command = JsonNavigateCommand.createExtractValue("$.original", roundTrip);
  ...
  void testMultipleFieldProcessing() throws Exception {
    ...
    IStreamCommand command1 =
        JsonNavigateCommand.createExtractValue("$.firstName", CamelToSnakeCaseRule.create());
    ...
    IStreamCommand command2 =
        JsonNavigateCommand.createExtractValue("$.lastName", CamelToSnakeCaseRule.create());
  ...
  void testErrorHandling() throws Exception {
    ...
    IStreamCommand command =
        JsonNavigateCommand.createExtractValue("$.field", CamelToSnakeCaseRule.create());
  ...
  void testNonExistentField() throws Exception {
    ...
    IStreamCommand command =
        JsonNavigateCommand.createExtractValue("$.nonExistent", CamelToSnakeCaseRule.create());
