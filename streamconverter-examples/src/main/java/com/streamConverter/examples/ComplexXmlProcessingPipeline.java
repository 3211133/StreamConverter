...
public class ComplexXmlProcessingPipeline {
  ...
  private static void demonstrateBasicPipeline() throws IOException {
    ...
    IStreamCommand extractUserId =
        XmlNavigateCommand.create(new XPath("request/body/user/userId"), new PassThroughRule());
    ...
    IStreamCommand extractSessionId =
        XmlNavigateCommand.create(new XPath("request/body/user/sessionId"), new PassThroughRule());
  ...
  private static void demonstrateErrorHandling() throws IOException {
    ...
    try {
      IStreamCommand xmlProcessor =
          XmlNavigateCommand.create(new XPath("request/header/requestId"), new PassThroughRule());
      ...
      processStep(
          recoveredXml,
          XmlNavigateCommand.create(new XPath("error"), new PassThroughRule()),
          "Recovery processing");
    }
  ...
  private static IStreamCommand[] createFullProcessingPipeline() {
    return new IStreamCommand[] {
      ...
      XmlNavigateCommand.create(new XPath("response/data"), new PassThroughRule())
    };
  }
